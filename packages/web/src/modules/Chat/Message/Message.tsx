          ...
          <div className={Style.contentButtonBlock} onMouseEnter={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave}>
            ...
            {showButtonList && (
              <div className={Style.buttonList}>
                <Tooltip placement={isSelf ? "left" : "right"} mouseEnterDelay={0.3} overlay={<span>Revoke</span>}>
                  <div>
                    <IconButton className={Style.button} icon="recall" iconSize={16} width={20} height={20} onClick={this.handleDeleteMessage} />
                  </div>
                </Tooltip>
              </div>
            )}
